...
class _CocktailsPageState extends State<CocktailsPage> {
  ...
  Future<List<dynamic>> fetchCocktailsByLetter(String letter) async {
    final response = await http.get(
      Uri.parse('https://www.thecocktaildb.com/api/json/v1/1/search.php?f=$letter'),
    );
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Card(
                          ...
                          child: ListTile(
                            title: Text(
                              widget.name.isNotEmpty ? widget.name : 'Unknown drink',
                              style: TextStyle(
                                fontWeight: FontWeight.bold,
                                fontSize: 16,
                              ),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Card(
                              child: ListTile(
                                ...
                                onTap: () async {
                                  final cocktailDetails = await fetchCocktailDetails(cocktail['idDrink']);
